      ...
      <div className="container mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-6">
            ...
            <Link to="/documentation#support" className="text-gray-300 hover:text-cyan-400 transition-colors duration-200">
              Support
            </Link>
          </nav>
            ...
            {user ? (
              ...
              <div className="flex items-center space-x-3">
                ...
                >
                  <Link
                    to="/signup"
                    className="block px-4 py-2 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 border border-cyan-500/30 text-cyan-400 rounded-lg hover:bg-gradient-to-r hover:from-cyan-500/30 hover:to-purple-500/30 transition-all duration-200"
                  >
                    Sign Up
                  </Link>
                </motion.div>
        ...
        {isMenuOpen && (
          ...
          >
            ...
            <Link
              to="/documentation"
              onClick={() => setIsMenuOpen(false)}
              className="flex items-2 gap-2 px-4 py-2 text-gray-300 hover:text-cyan-400 hover:bg-gray-800/50 rounded-lg transition-colors duration-200"
            >
